...
createQuestionnaire({
	cognitiveFunctionsDescription: 'These are the cognitive functions of your perfect match ordered by usage:',
	typeDescription: 'This is your ideal MBTI match type:',
	questionsPerCognitiveFunction: 10,
	minDisplayedQuestionsPerCognitiveFunction: 3,
	defaultDisplayedQuestionsPerCognitiveFunction: 5,
	fullyAgreeText: 'Fully agree',
	agreeText: 'Agree',
	slightlyAgreeText: 'Slightly agree',
	neutralText: 'Neutral',
	slightlyDisagreeText: 'Slightly disagree',
	disagreeText: 'Disagree',
	fullyDisagreeText: 'Fully disagree',
	questions: {
		Se: [
			`My perfect match should enjoy what is happening right now and not worry about the past and future.`,
			// `I fear missing out on current enjoyments and possibilities.`,
			// `I quickly notice opportunities that others miss.`,
			`My perfect match should see situations without judging them.`,
			`My perfect match should be rather practical. Learning is doing.`,
			// `Talk is cheap. Actions are valueable.`,
			`My perfect match should be  stimulated by physical challenges and should sometimes even take physical risks.`,
			`My perfect match shouldn't micro-manage or fully control their life.`,
			`My perfect match should like to fully immerse theirselves in the sensations around them.`,
